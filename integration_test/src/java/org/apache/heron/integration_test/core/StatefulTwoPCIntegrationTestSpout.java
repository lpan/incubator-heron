...
public class StatefulTwoPCIntegrationTestSpout<K extends Serializable, V extends Serializable>
    extends IntegrationTestSpout implements ITwoPhaseStatefulComponent<K, V> {

  private static final long serialVersionUID = -3651385732407518328L;
  private ITwoPhaseStatefulComponent<K, V> delegate;

  public StatefulTwoPCIntegrationTestSpout(IRichSpout delegateSpout,
                                           int maxExecutions, String topologyStartedStateUrl) {
    super(delegateSpout, maxExecutions, topologyStartedStateUrl);
    this.delegate = (ITwoPhaseStatefulComponent<K, V>) delegateSpout;
  }
  ...
  public void postSave(String checkpointId) {
    this.delegate.postSave(checkpointId);
  }

  @Override
  public void preRestore(String checkpointId) {
    this.delegate.preRestore(checkpointId);
  }
}
